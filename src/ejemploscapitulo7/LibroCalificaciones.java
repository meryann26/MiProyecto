...
// llama a los métodos obtenerMinima y obtenerMaxima
        ...
        // llama a imprimirGraficoBarras para imprimir el gráfico de distribución calificaciones 
        imprimirGraficoBarras();
    }

// busca la calificación más baja
    public int obtenerMinima() {
        int califBaja = calificaciones[0]; // asume que calificaciones[0] es la baja 
...
// busca la calificación más alta
    public int obtenerMaxima() {
        int califAlta = calificaciones[0]; // asume que calificaciones[0] es la alta 
